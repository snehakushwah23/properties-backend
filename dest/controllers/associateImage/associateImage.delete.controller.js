...
exports.deleteAssociateImageController = deleteAssociateImageController;
const mongodb_1 = require("../../services/mongodb");
const response_messages_1 = require("../../constants/response.messages");
const delete_object_1 = require("../../helpers/delete.object");
async function deleteAssociateImageController(req, res) {
    try {
        ...
        const deletedImage = await mongodb_1.ASSOCIATE_IMAGE.findByIdAndDelete(imageID);
...
//# sourceMappingURL=associateImage.delete.controller.js.map