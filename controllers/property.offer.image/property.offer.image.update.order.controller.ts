...
export async function propertyOfferImageOrderUpdateController(req: Request, res: Response) {
    try {
        ...
        const existingPhotos = await PROPERTY_OFFER_IMAGE.find({ propertyID });
        ...
        await PROPERTY_OFFER_IMAGE.bulkWrite(bulkUpdateOperations);
